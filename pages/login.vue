...
<template>
    <section class="bg-zinc-900 dark:bg-zinc-900">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form @submit.prevent="handleLogin" class="space-y-4 md:space-y-6" >
                  ...
                  <div>
                      ...
                      <input type="password" name="password" id="password" placeholder="••••••••" class="bg-zinc-50 border border-zinc-300 text-zinc-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                  </div>
